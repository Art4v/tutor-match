...
// Same levels, highest-first (Year 12 → Kindergarten) — for the year filter
// dropdowns where students self-select their grade (senior years are the common
// case, so they lead). The settings tick scale keeps the ascending YEAR_LEVELS.
export const YEAR_LEVELS_DESC = [...YEAR_LEVELS].reverse();
