...
export function adminReportEmail({ reporterName, reportedName, category, details, reviewUrl }) {
  ...
  return wrap(`
    ...
    <p style="font-size:12px;color:${MUTED};">The link opens a review page with the full conversation, where you can disable either account or dismiss the report. Nothing changes until you choose there.</p>
  `);
}
