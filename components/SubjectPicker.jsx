  ...
  const trigger =
    variant === "bar" ? (
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-center gap-2 sm:gap-3 px-3 sm:px-4 h-[46px] sm:h-[48px] text-left transition-colors rounded-[10px] hover:bg-[color:var(--accent-softer)]"
      >
        <Icon name="search" size={16} className="text-[color:var(--accent)] shrink-0" />
